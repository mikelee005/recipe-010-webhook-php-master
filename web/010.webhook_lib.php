...
class Webhook_lib {
    ...
    # Settings
    # 
    public $ds_user_email = "mikelee005@gmail.com"; 
    public $ds_user_pw = "N#ewport4331"; 
    public $ds_integration_id = "4ed5be53-a1e4-49d4-80bd-563d4635eb9d";
    public $ds_signer1_name = "***";  # Set signer info here or leave as is to use example signers
    public $ds_signer1_email = "webhooktest@mailinator.com";
    public $ds_cc1_name = "***";  # Set a cc recipient here or leave as is to use example recipients
    public $ds_cc1_email = "webhooktestcc@mailinator.com";
